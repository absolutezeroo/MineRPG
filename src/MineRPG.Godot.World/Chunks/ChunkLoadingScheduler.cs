...
public sealed partial class ChunkLoadingScheduler : Node
{
    ...
    /// </summary>
    public int CurrentRenderDistance { get; private set; } = DefaultRenderDistance;
    ...
    public void EnqueueSave(ChunkCoord coord, ushort[] blockSnapshot) => _workerPool.EnqueueSave(coord, blockSnapshot);
    ...
    {
        CurrentRenderDistance = Math.Clamp(distance, 4, 64);
        _performanceMonitor?.SetRenderDistance(CurrentRenderDistance);
    }
