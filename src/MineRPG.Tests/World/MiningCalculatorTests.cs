...
public sealed class MiningCalculatorTests
{
    ...
    public void ComputeMineTime_BareHandsOnSoftBlock_NoPenalty()
    {
        ...
        BlockDefinition block = CreateBlock(hardness: 1f, requiredToolType: "shovel", minimumToolTier: 0);
    ...
    public void ComputeMineTime_WrongToolType_AppliesPenalty()
    {
        ...
        BlockDefinition block = CreateBlock(hardness: 2f, requiredToolType: "pickaxe", minimumToolTier: 1);
    ...
    public void ComputeMineTime_CorrectToolCorrectTier_NoMalus()
    {
        ...
        BlockDefinition block = CreateBlock(hardness: 5f, requiredToolType: "pickaxe", minimumToolTier: 1);
    ...
    public void ComputeMineTime_MatchingTypeTierTooLow_SpeedBonusNoPenalty()
    {
        ...
        BlockDefinition block = CreateBlock(hardness: 3f, requiredToolType: "pickaxe", minimumToolTier: 3);
    ...
    public void IsCorrectTool_PreferredToolNoMinTier_AlwaysTrue()
    {
        ...
        BlockDefinition block = CreateBlock(requiredToolType: "shovel", minimumToolTier: 0);
    ...
    {
        BlockDefinition block = CreateBlock(requiredToolType: "pickaxe", minimumToolTier: 2);
    ...
    {
        BlockDefinition block = CreateBlock(requiredToolType: "pickaxe", minimumToolTier: 1);
    ...
    {
        BlockDefinition block = CreateBlock(requiredToolType: "pickaxe", minimumToolTier: 3);
